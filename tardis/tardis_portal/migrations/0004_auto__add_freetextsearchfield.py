...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tardis_portal_freetextsearchfield', (
            ...
            ('parameter_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.ParameterName'])),
        ))
        db.send_create_signal('tardis_portal', ['FreeTextSearchField'])
    ...
    models = {
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 8)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
