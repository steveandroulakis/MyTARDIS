...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tardis_portal_registrationstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('site', self.gf('django.db.models.fields.CharField')(max_length=400, blank=True)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tardis_portal.Experiment'], null=True, blank=True)),
        ))
        db.send_create_signal('tardis_portal', ['RegistrationStatus'])

        # Adding field 'Dataset_File.transfer_status'
        db.add_column('tardis_portal_dataset_file', 'transfer_status',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dataset_File.transfer_status_timestamp'
        db.add_column('tardis_portal_dataset_file', 'transfer_status_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'RegistrationStatus'
        db.delete_table('tardis_portal_registrationstatus')

        # Deleting field 'Dataset_File.transfer_status'
        db.delete_column('tardis_portal_dataset_file', 'transfer_status')

        # Deleting field 'Dataset_File.transfer_status_timestamp'
        db.delete_column('tardis_portal_dataset_file', 'transfer_status_timestamp')
    ...
    models = {
        ...
        'tardis_portal.dataset_file': {
            ...
            'transfer_status': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'transfer_status_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        'tardis_portal.registrationstatus': {
            ...
            'site': ('django.db.models.fields.CharField', [], {'max_length': '400', 'blank': 'True'}),
        ...
        'tardis_portal.token': {
            ...
            'experiment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tardis_portal.Experiment']"}),
            'expiry_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 11)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
