...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Job.experiment_id'
        db.delete_column('mrtardis_job', 'experiment_id_id')

        # Adding field 'Job.experiment'
        db.add_column('mrtardis_job', 'experiment', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tardis_portal.Experiment']), keep_default=False)

        # Adding field 'Job.user'
        db.add_column('mrtardis_job', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Job.experiment_id'
        db.add_column('mrtardis_job', 'experiment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tardis_portal.Experiment']), keep_default=False)

        # Deleting field 'Job.experiment'
        db.delete_column('mrtardis_job', 'experiment_id')

        # Deleting field 'Job.user'
        db.delete_column('mrtardis_job', 'user_id')
