...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.user'
        db.alter_column('mrtardis_job', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mrtardis.MrTUser']))


    def backwards(self, orm):
        
        # Changing field 'Job.user'
        db.alter_column('mrtardis_job', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'mrtardis.job': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mrtardis.MrTUser']"})
        },
        'mrtardis.mrtuser': {
