...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MrTUser.testedConnection'
        db.add_column('mrtardis_mrtuser', 'testedConnection', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MrTUser.testedConnection'
        db.delete_column('mrtardis_mrtuser', 'testedConnection')
